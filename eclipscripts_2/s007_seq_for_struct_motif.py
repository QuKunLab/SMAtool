...
import sys
#
struct_df_dir = sys.argv[1] + '/'   # for example, DMS_struct_motif_dataframe
binding_sites_on_motif = struct_df_dir + '/binding_sites_on_trans.csv'
begin_base = struct_df_dir + '/motif_start_base.csv'
fasta_dir = sys.argv[2] + '/' # for example, DMS_K562_45bp_all
output_dir = sys.argv[3] + '/' # for example, DMS_seq_on_struct
try:
